...
const FooterMiddle = () => {
  ...
  <div className='d-flex  h-100 '>
        <img style={{marginTop:"20px"}} src={location} alt="" width="24px" height="24px" />
  ...
  <div className=" d-flex w-25 align-items-start  flex-column   justify-content-center ">
  <div className='d-flex  h-100 '>
        <img style={{marginTop:"10px"}} src={mail} alt="" width="24px" height="24px" />
        <div className=' mt-2 ms-3 fs-6 textpclr'>
            greenshop@gmail.com
            </div>
    </div>
  ...
  <div className=" d-flex w-25 align-items-start  flex-column   justify-content-center ">
  <div className='d-flex  h-100 '>
        <img style={{marginTop:"10px"}} src={phone} alt="" width="24px" height="24px" />
...
const Footer = () => {
  return (
    ...
    <div className="text-center my-2 grayclr">&copy; 2023 GREENSHOP, ALL RIGHTS RESERVED. </div>
    </div>
  );
};
